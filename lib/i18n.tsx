...
const translations: Translations = {
  ...
  logActionCreate: { en: "Create", ar: "إنشاء" },
  logActionUpdate: { en: "Update", ar: "تعديل" },
  logActionDelete: { en: "Delete", ar: "حذف" },
  logActionLogin: { en: "Login", ar: "تسجيل الدخول" },
  logActionLogout: { en: "Logout", ar: "تسجيل الخروج" },
  entityContact: { en: "Contact", ar: "جهة اتصال" },
  entityConversation: { en: "Conversation", ar: "محادثة" },
  entityMessage: { en: "Message", ar: "رسالة" },
  entityTemplate: { en: "Template", ar: "قالب" },
  ...
  totalConversationsLabel: { en: "Total Conversations", ar: "إجمالي المحادثات" },
  totalContactsLabel: { en: "Total Contacts", ar: "إجمالي جهات الاتصال" },
  avgResponseTimeLabel: { en: "Avg Response Time", ar: "متوسط وقت الاستجابة" },
  totalMessagesLabel: { en: "Total Messages", ar: "إجمالي الرسائل" },
  analyticsPageDescription: { en: "View insights and performance metrics", ar: "عرض التحليلات ومؤشرات الأداء" },
  fromLastMonth: { en: "from last month", ar: "مقارنة بالشهر الماضي" },
  activeConversationsLabel: { en: "Active Conversations", ar: "المحادثات النشطة" },
  currentlyActive: { en: "Currently active", ar: "نشطة حالياً" },
  quickResponses: { en: "Quick responses", ar: "ردود سريعة" },
  basedOnResponses: { en: "Based on responses", ar: "استناداً إلى الردود" },
  activeUsersLabel: { en: "Active Users", ar: "المستخدمون النشطون" },
  dailyActivityTitle: { en: "Daily Activity", ar: "النشاط اليومي" },
  dailyActivityDesc: { en: "Messages and conversations over the last 7 days", ar: "الرسائل والمحادثات خلال آخر 7 أيام" },
  messagesLabel: { en: "messages", ar: "رسالة" },
  conversationStatusTitle: { en: "Conversation Status", ar: "حالة المحادثات" },
  conversationStatusDesc: { en: "Distribution of conversation states", ar: "توزيع حالات المحادثات" },
  teamPerformanceDesc: { en: "Agent activity and conversation handling", ar: "نشاط الموظفين وتعاملهم مع المحادثات" },
  conversationsLabel: { en: "conversations", ar: "محادثة" },
  efficiencyLabel: { en: "efficiency", ar: "كفاءة" },
  noTeamPerformanceData: { en: "No team performance data available", ar: "لا توجد بيانات لأداء الفريق متاحة" },
  ...
  templateCategoryOnboarding: { en: "Onboarding", ar: "الترحيب والانضمام" },
  templateCategorySales: { en: "Sales", ar: "المبيعات" },
  templateCategorySupport: { en: "Support", ar: "الدعم" },
  templateCategoryMarketing: { en: "Marketing", ar: "التسويق" },
  ...
  updatedLabel: { en: "Updated", ar: "تم التحديث" },
  editFlow: { en: "Edit Flow", ar: "تعديل السير" },
  viewStats: { en: "View Stats", ar: "عرض الإحصائيات" },
  flowBuilderDescription: { en: "Build automated workflows with drag-and-drop", ar: "بناء سيور عمل آلية بالسحب والإفلات" },
  ...
  crmLabel: { en: "CRM", ar: "إدارة العملاء" },
